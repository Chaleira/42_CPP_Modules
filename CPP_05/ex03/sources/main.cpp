...
int main (void)
{
	...
	try
	{
		std::cout << "Creating a form with the Intern" << std::endl << std::endl;
		...
		AForm *robotomy = intern.makeForm("robotomy request", "form1");
		AForm *presidential = intern.makeForm("presidential pardon", "form2");
		AForm *shrubbery = intern.makeForm("shrubbery creation", "form3");
		std::cout << "------------------------------------------" << std::endl;
